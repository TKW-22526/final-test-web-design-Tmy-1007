const productlist = [
    ...
    },
    {
        ...
        detail: "The Baby Room is designed to capture the sweetest and most innocent moments of childhood. Decorated with soft pastel colors, adorable toys, and cozy furnishings, the room creates a warm and joyful atmosphere for babies and families. Every corner is carefully arranged to highlight natural expressions, precious smiles, and unforgettable memories. The gentle lighting and charming decorations provide a comfortable environment for both children and parents. The Baby Room is the perfect setting to preserve early-life milestones and create heartwarming photographs filled with love, happiness, and lasting memories."
    }
];
